...
- **Sheets Service** (`sheets/`): 14 tools (spreadsheet create/get, values get/update/append/clear, sheet duplicate/add/delete/update, dimension insert/delete, cells format/get format) + multi-account support via `sheets/multi_account.go`
